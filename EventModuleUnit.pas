...
uses
  ...
  uniLabel, uniMultiItem, uniComboBox, uniGUIBaseClasses, uniGroupBox, Main, UniCalendarPanel;
...
begin
  ...
  begin
    ...
    for I := 0 to Calendar.Calendars.Count - 1 do
      UniComboBox1.Items.Add(IntToStr(Calendar.Calendars[I].CalendarId));
  end;
end;
