...
uses
  ...
  uADDAptManager, Data.DB, uADCompDataSet, uADCompClient, uniGUIBaseClasses,
  uniEdit, uniDBEdit, uniButton, uniBitBtn, uniToolBar, uniPanel,
  uniLabel, Funciones, Frm_Browse, UniGuiDialogs, Vcl.Forms;
...
type
  ...
  TFrmDialogo2 = class(TUniForm)
    ...
    procedure UniFormKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure DatasetReconcileError(DataSet: TADDataSet; E: EADException;
      UpdateKind: TADDatSRowState; var Action: TADDAptReconcileAction);
    procedure ADClienteAfterGetRecord(DataSet: TADDataSet);
  ...
  public
    ...
    procedure AddListaDetalles(Detalle:TADDataSet);
...
procedure TFrmDialogo2.ADClienteAfterGetRecord(DataSet: TADDataSet);
begin
  ActualizaDetalles;
end;
...
procedure TFrmDialogo2.DatasetReconcileError(DataSet: TADDataSet;
  E: EADException; UpdateKind: TADDatSRowState;
...
procedure TFrmDialogo2.AddListaDetalles(Detalle:TADDataSet);
var
  i:Integer;
begin
  i:=0;
